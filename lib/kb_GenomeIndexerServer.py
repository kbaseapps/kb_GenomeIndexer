...
def get_config():
    ...
    for nameval in config.items(get_service_name() or 'kb_GenomeIndexer'):
        retconfig[nameval[0]] = nameval[1]
    return retconfig

config = get_config()

from kb_GenomeIndexer.kb_GenomeIndexerImpl import kb_GenomeIndexer  # noqa @IgnorePep8
impl_kb_GenomeIndexer = kb_GenomeIndexer(config)
...
class Application(object):
    ...
    def __init__(self):
        submod = get_service_name() or 'kb_GenomeIndexer'
        ...
        self.rpc_service.add(impl_kb_GenomeIndexer.genome_index,
        ...
        self.rpc_service.add(impl_kb_GenomeIndexer.genomenoncodingfeatures_mapping,
                             name='kb_GenomeIndexer.genomenoncodingfeatures_mapping',
                             types=[dict])
        self.method_authentication['kb_GenomeIndexer.genomenoncodingfeatures_mapping'] = 'required'  # noqa
